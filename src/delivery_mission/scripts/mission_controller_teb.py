...
# -*- coding: utf-8 -*-
"""
Mission Controller (TEB版)
与原 mission_controller.py 完全相同，
唯一区别: pure_pursuit 的 cmd_topic 改为 /pp_cmd_vel，
由 planner_switch 节点负责转发到 /smoother_cmd_vel。
"""
...
class MissionController:
    def __init__(self):
        ...
        rospy.loginfo("MissionController(TEB) initialized, state=WAIT_FLAG")
